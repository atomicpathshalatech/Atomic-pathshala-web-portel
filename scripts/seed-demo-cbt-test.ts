...
export async function seedDemoCbtTest() {
  ...
  const questionsData = [
    // BIOLOGY (Q1 - Q4)
    {
      ...
      subTopic: "S Phase (Synthesis Phase)",
      type: "SINGLE_CORRECT",
      difficulty: "EASY",
      ncertBook: "NCERT Class 11 Biology",
      ncertClass: "Class 11",
      ncertChapter: "Cell Cycle and Cell Division",
      ncertPage: "163",
      ncertSection: "10.1.1 S Phase",
    ...
    },
    {
      ...
      subTopic: "Heart Chambers & Blood Flow",
      ...
      ncertPage: "283",
      ncertSection: "18.3.1 Human Heart & Chambers",
    ...
    },
    {
      ...
      type: "SINGLE_CORRECT",
      difficulty: "MEDIUM",
      ncertBook: "NCERT Class 12 Biology",
      ncertClass: "Class 12",
      ncertChapter: "Principles of Inheritance and Variation",
      ncertPage: "72",
      ncertSection: "5.2.1 Law of Segregation & Punnett Square",
    ...
    },
    {
      ...
      ncertPage: "216",
      ncertSection: "13.6 The Calvin Cycle (C3 Pathway)",
    ...
    // CHEMISTRY (Q5 - Q7)
    {
      ...
      type: "NUMERICAL",
      difficulty: "EASY",
      ncertBook: "NCERT Class 11 Chemistry Part 1",
      ncertClass: "Class 11",
      ncertChapter: "Structure of Atom",
      ncertPage: "62",
      ncertSection: "2.6.4 Pauli Exclusion Principle",
    ...
    },
    {
      ...
      topic: "VSEPR Theory & Dipole Moment",
      subTopic: "Linear Geometry & Vector Cancellation",
      type: "ASSERTION_REASON",
      difficulty: "MEDIUM",
      ncertBook: "NCERT Class 11 Chemistry Part 1",
      ncertClass: "Class 11",
      ncertChapter: "Chemical Bonding and Molecular Structure",
      ncertPage: "108",
      ncertSection: "4.2 VSEPR Theory & 4.3 Dipole Moment",
    ...
    },
    {
      ...
      subTopic: "Branched Alkanes",
      type: "SINGLE_CORRECT",
      difficulty: "EASY",
      ncertBook: "NCERT Class 11 Chemistry Part 2",
      ncertClass: "Class 11",
      ncertChapter: "Organic Chemistry - Some Basic Principles and Techniques",
      ncertPage: "338",
      ncertSection: "12.4.1 Nomenclature of Alkanes",
    ...
    // PHYSICS (Q8 - Q10)
    {
      ...
      subTopic: "Dimensional Formulae of Universal Constants",
      type: "SINGLE_CORRECT",
      difficulty: "MEDIUM",
      ncertBook: "NCERT Class 11 Physics Part 1",
      ncertClass: "Class 11",
      ncertChapter: "Units and Measurements",
      ncertPage: "31",
      ncertSection: "2.8 Dimensional Analysis and Its Applications",
    ...
    },
    {
      ...
      ncertPage: "47",
      ncertSection: "3.6 Kinematic Equations for Uniformly Accelerated Motion",
  ...
  for (const q of questionsData) {
    ...
    await prisma.question.upsert({
      ...
      create: {
        ...
        topic: q.topic,
        subTopic: q.subTopic,
        type: (q.type || "SINGLE_CORRECT") as any,
        difficulty: q.difficulty as any,
        ncertBook: q.ncertBook,
