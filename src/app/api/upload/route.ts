...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      if (storageErr instanceof StorageNotConfiguredError || (storageErr as any)?.name === "StorageNotConfiguredError") {
        // Fallback to saving file in local public/uploads directory for development/fallback
        try {
          ...
          console.error("Local file write error:", localWriteErr);
          // If filesystem write fails, return inline data URL for PDFs
