        ...
        {canCreate && (
          <div className="flex items-center gap-3 flex-wrap">
            <Link
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-blue-700 via-blue-700 to-blue-800 text-white px-5 py-2.5 rounded-full font-bold text-xs hover:opacity-95 transition-all shadow-md shadow-blue-600/20 active:scale-95"
            ...
            <Link
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-blue-600 via-blue-600 to-blue-600 text-white px-5 py-2.5 rounded-full font-bold text-xs hover:opacity-95 transition-all shadow-md shadow-blue-500/20 active:scale-95"
            ...
            <Link
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-600 text-white px-5 py-2.5 rounded-full font-bold text-xs hover:opacity-95 transition-all shadow-md shadow-blue-500/20"
