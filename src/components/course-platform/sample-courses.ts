...
export const SAMPLE_COURSES: CourseData[] = [
  {
    id: "c-yodha-chem",
    slug: "yodha-chemistry-neet",
    title: "YODHA Chemistry Batch for NEET",
  ...
  {
    id: "c-prahar-phy",
    slug: "prahar-physics-jee",
    title: "PRAHAR Physics Batch for JEE",
  ...
  {
    id: "c-victor-bio",
    slug: "victor-biology-neet",
    title: "VICTOR Complete Biology for NEET",
