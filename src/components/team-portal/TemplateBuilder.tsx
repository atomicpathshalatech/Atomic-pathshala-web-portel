        ...
        <div className="flex bg-slate-800 p-1 rounded-xl border border-slate-700">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
              tab === "SELECT" ? "bg-blue-600 text-white shadow-sm" : "text-slate-400 hover:text-white"
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
              tab === "CREATE" ? "bg-blue-600 text-white shadow-sm" : "text-slate-400 hover:text-white"
            }`}
          >
            + Create New Template
          </button>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-3 text-xs">
                          ...
                          <span className="bg-blue-100 text-blue-700 px-2.5 py-1 rounded-lg font-medium">
                            {qCount} Questions
                          </span>
                      ...
                      <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-slate-100">
                        {tpl.sections.map((sec) => (
                          ...
                          >
                            ...
                            <span className="font-semibold text-blue-600">{sec.targetCount}Q</span>
                          </div>
                        ))}
                      </div>
                    </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 pb-2">
              ...
              <button
                ...
                className="px-2.5 py-1 bg-blue-50 text-blue-700 hover:bg-blue-100 text-xs font-medium rounded-lg transition"
              >
                NEET (180Q / 720 Marks)
              </button>
              <button
            ...
            <div className="border border-slate-200 rounded-xl p-3 bg-slate-50/50">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-bold text-slate-900 flex items-center gap-1.5">
                  <BookOpen className="w-3.5 h-3.5 text-blue-600" /> Sections Breakdown ({sections.length})
                </span>
                <button
                  type="button"
                  onClick={handleAddSection}
                  className="px-2.5 py-1 bg-blue-600 text-white text-xs font-semibold rounded-lg hover:bg-blue-700 flex items-center gap-1"
                >
                  ...
                  >
                    <div className="col-span-3">
                      ...
                      <input
                        ...
                        className="w-full px-2 py-1 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-xs"
                      />
                    </div>
                    <div className="col-span-3">
                      ...
                      <select
                        ...
                        className="w-full px-2 py-1 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-xs bg-white"
                      >
                    ...
                    <div className="col-span-2">
                      ...
                      <input
                        ...
                        className="w-full px-2 py-1 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-xs font-semibold text-center"
                      />
                    </div>
                    <div className="col-span-2">
                      ...
                      <input
                        ...
                        className="w-full px-2 py-1 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-xs text-center"
                      />
                    </div>
                    <div className="col-span-1">
                      ...
                      <input
                        ...
                        className="w-full px-1.5 py-1 border border-slate-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-xs text-center text-red-600"
                      />
                    </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 flex items-center justify-between text-xs">
              <div className="flex items-center gap-2 text-blue-900 font-semibold">
                <Calculator className="w-4 h-4 text-blue-600" /> Live Calculated Blueprint:
              </div>
              <div className="flex items-center gap-4">
                <span className="text-slate-700 font-medium">
                  Total Questions: <strong className="text-blue-700">{totalQuestions}</strong>
                </span>
                <span className="text-slate-700 font-medium">
        ...
        <div className="flex items-center gap-2">
          {tab === "SELECT" ? (
            <button
              ...
              className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-xl disabled:opacity-50 transition shadow-sm"
            >
