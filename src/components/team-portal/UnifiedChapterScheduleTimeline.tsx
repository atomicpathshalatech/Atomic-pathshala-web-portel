              ...
              >
                ...
                <div className="flex items-center gap-2 sm:self-center pl-9 sm:pl-0">
                  ...
                  {item.type === "LECTURE" && item.lectureData && (
                    <>
                      <Link
                        href={`/team/live-class/${item.lectureData.id}`}
                  ...
                  {item.type === "DPP" && item.dppData && (
                    <Link
                      href={`/team/dpps/${item.dppData.id}`}
                    ...
                    <div className="relative">
                      ...
                      {isMenuOpen && (
                        <>
                          ...
                          />
                          <div className="absolute right-0 top-10 z-30 w-48 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 p-1.5 space-y-1">
                            {/* Edit Action */}
                            {item.type === "LECTURE" && item.lectureData && (
                              <button
                                type="button"
                            ...
                            <button
                              ...
                              className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-950/50 transition text-left cursor-pointer"
                            >
