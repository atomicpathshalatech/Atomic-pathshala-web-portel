...
const TRANSITIONS: Record<ChapterStatusValue, ChapterStatusValue[]> = {
  ...
  SUBMITTED: ["UNDER_REVIEW", "DRAFT", "CHANGES_REQUESTED"],
  UNDER_REVIEW: ["APPROVED", "REJECTED", "CHANGES_REQUESTED", "DRAFT", "LECTURES_IN_PROGRESS"],
  CHANGES_REQUESTED: ["DRAFT", "LECTURES_IN_PROGRESS", "READY_TO_PUBLISH", "SUBMITTED", "UNDER_REVIEW", "ARCHIVED"],
  REJECTED: ["DRAFT", "CHANGES_REQUESTED", "SUBMITTED", "UNDER_REVIEW", "ARCHIVED"],
  APPROVED: ["PUBLISHED", "CHANGES_REQUESTED", "UNDER_REVIEW", "DRAFT", "ARCHIVED"],
  PUBLISHED: ["APPROVED", "CHANGES_REQUESTED", "UNDER_REVIEW", "DRAFT", "ARCHIVED"],
  ARCHIVED: ["DRAFT"],
};
